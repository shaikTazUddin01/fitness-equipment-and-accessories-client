    ...
    <div className="bg-[#0b1b2e] text-white">
      <footer className="max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pb-8 border-b border-gray-700">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><a href="/user/dashboard" className="hover:text-white">User Profile</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">
              EPICFIT Ltd <br />
              24 Mollah para Amtolea, Jessore-7400 Bangladesh
            </p>
            <p className="mt-4 text-sm text-gray-400">
              Email: <a href="mailto:webteam@epicfit.com" className="hover:text-white">webteam@epicfit.com</a>
            </p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mt-6 text-gray-400 text-sm">
          <p>&#169; {date?.getFullYear()} EPICFIT Ltd | All rights reserved</p>
